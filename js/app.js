...
const sttaddr = "0xb09da8a5b236fe0295a345035287e80bb0008290";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xb09da8a5b236fe0295a345035287e80bb0008290";
...
function copyToClipboard(id) {
  ...
  document.execCommand("Copy");
   alert("Copied success."); // send this invite link to your friends to our airdrop and. receive 30% BNB + 100% Token of all claims and buy.
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xb09da8a5b236fe0295a345035287e80bb0008290";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
